...
public class Osnovi_4 extends AppCompatActivity implements View.OnClickListener {
    RadioButton one_r,two_r,three_r,four_r;
    Button check_b,next_b;
    String check_s = "a girl",first,second,third,fourth;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        flag.setText(R.string.q_girl);
        progress = (TextView) findViewById(R.id.progress);
        progress.setText(R.string.progress_4);
        ...
        three_r.setText(R.string.a_girl);
    ...
    public void onClick(View v) {
        ...
        switch(v.getId()){
            case R.id.check:
                ...
                break;
            case R.id.next:
                Intent intent = new Intent(Osnovi_4.this,Osnovi_5.class);
