...
public class Osnovi_6 extends AppCompatActivity implements View.OnClickListener {
    RadioButton one_r,two_r,three_r,four_r;
    Button check_b,next_b;
    String check_s = "bread",first,second,third,fourth;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        flag.setText(R.string.q_bread);
        progress = (TextView) findViewById(R.id.progress);
        progress.setText(R.string.progress_6);


        one_r = (RadioButton) findViewById(R.id.one);
        one_r.setOnClickListener(this);
        one_r.setCompoundDrawablesWithIntrinsicBounds(null,getResources().getDrawable(R.drawable.an_apple),null,null);
        one_r.setText(R.string.an_apple);
        two_r = (RadioButton) findViewById(R.id.two);
        two_r.setCompoundDrawablesWithIntrinsicBounds(null,getResources().getDrawable(R.drawable.bread),null,null);
        two_r.setText(R.string.bread);
        two_r.setOnClickListener(this);
        three_r = (RadioButton) findViewById(R.id.three);
        three_r.setCompoundDrawablesWithIntrinsicBounds(null,getResources().getDrawable(R.drawable.a_woman),null,null);
        three_r.setText(R.string.a_woman);
        three_r.setOnClickListener(this);
        four_r = (RadioButton) findViewById(R.id.fourth);
        four_r.setCompoundDrawablesWithIntrinsicBounds(null,getResources().getDrawable(R.drawable.water),null,null);
        four_r.setText(R.string.water);
    ...
    public void onClick(View v) {
        ...
        switch(v.getId()){
            case R.id.check:
                ...
                break;
            case R.id.next:
                Intent intent = new Intent(Osnovi_6.this,Osnovi_7.class);
