...
public class Osnovi_5 extends AppCompatActivity implements View.OnClickListener {
    RadioButton one_r,two_r,three_r,four_r;
    Button check_b,next_b;
    String check_s = "an apple",first,second,third,fourth;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        flag.setText(R.string.q_apple);
        progress = (TextView) findViewById(R.id.progress);
        progress.setText(R.string.progress_5);
        ...
        four_r.setCompoundDrawablesWithIntrinsicBounds(null,getResources().getDrawable(R.drawable.bread),null,null);
        four_r.setText(R.string.bread);
    ...
    public void onClick(View v) {
        ...
        switch(v.getId()){
            case R.id.check:
                ...
                break;
            case R.id.next:
                Intent intent = new Intent(Osnovi_5.this,Osnovi_6.class);
