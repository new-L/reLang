...
public class Osnovi_3 extends AppCompatActivity implements View.OnClickListener {
    RadioButton one_r,two_r,three_r,four_r;
    Button check_b,next_b;
    String check_s = "a man",first,second,third,fourth;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        flag.setText(R.string.q_man);
        progress = (TextView) findViewById(R.id.progress);
        progress.setText(R.string.progress_3);
    ...
    public void onClick(View v) {
        ...
        switch(v.getId()){
            case R.id.check:
                ...
                break;
            case R.id.next:
                Intent intent = new Intent(Osnovi_3.this,Osnovi_4.class);
