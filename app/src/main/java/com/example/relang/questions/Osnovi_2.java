...
public class Osnovi_2 extends AppCompatActivity implements View.OnClickListener {
    RadioButton one_r,two_r,three_r,four_r;
    Button check_b,next_b;
    String check_s = "a woman",first,second,third,fourth;
   ...
   int point;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        flag.setText(R.string.q_woman);
        progress = (TextView) findViewById(R.id.progress);
        progress.setText(R.string.progress_2);
        one_r = (RadioButton) findViewById(R.id.one);
        one_r.setOnClickListener(this);
        one_r.setCompoundDrawablesWithIntrinsicBounds(null,getResources().getDrawable(R.drawable.a_man),null,null);
        one_r.setText(R.string.a_man);
        two_r = (RadioButton) findViewById(R.id.two);
        two_r.setCompoundDrawablesWithIntrinsicBounds(null,getResources().getDrawable(R.drawable.a_woman),null,null);
        two_r.setText(R.string.a_woman);
        two_r.setOnClickListener(this);
        three_r = (RadioButton) findViewById(R.id.three);
        three_r.setCompoundDrawablesWithIntrinsicBounds(null,getResources().getDrawable(R.drawable.bread),null,null);
        three_r.setText(R.string.bread);
        three_r.setOnClickListener(this);
        four_r = (RadioButton) findViewById(R.id.fourth);
        four_r.setCompoundDrawablesWithIntrinsicBounds(null,getResources().getDrawable(R.drawable.a_girl),null,null);
        four_r.setText(R.string.a_girl);
    ...
    public void onClick(View v) {
        ...
        switch(v.getId()){
            case R.id.check:
                ...
                break;
            case R.id.next:
                Intent intent = new Intent(Osnovi_2.this,Osnovi_3.class);
